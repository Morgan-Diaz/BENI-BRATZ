...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2024 at 06:32 AM
...
INSERT INTO `cart` (`cart_id`, `registration_id`, `product_id`, `quantity`, `added_at`, `variant_id`) VALUES
(1, 1, 6, 2, '2024-11-25 05:44:50', 8);
...
INSERT INTO `login_credentials` (`login_id`, `registration_id`, `email`, `password`, `created_at`) VALUES
(2, 1, 'tonz@gmail.com', '1234', '2024-11-18 07:37:39'),
(17, 16, 'qwerty@gmail.com', '$2y$10$0NMNxVNdxGGl/CKxfvZ04.iqU4zEWAK7yKp5bOQ4CWPE1H.RLfaDG', '2024-11-25 07:23:37');
...
(1, 'Chocolate', 'Indulgence of Artistry in every bite', 'product1.jpg', '2024-10-20 04:59:23'),
(2, 'Vanilla', 'Divine Delight, Simplicity perfected', 'product2.jpg', '2024-10-20 04:59:23'),
(3, 'Strawberry', 'Sweet Elegance, A bite of bliss', 'product3.jpg', '2024-10-20 04:59:23'),
(4, 'Coconut', 'Tropical Touch, Refreshing and rich', 'product4.jpg', '2024-10-20 04:59:23'),
(5, 'Ube', 'Filipino Flavor, Exquisite ube goodness', 'product5.jpg', '2024-10-20 04:59:23'),
(6, 'Blueberry', 'Berry Goodness, Fresh from the farm', 'product6.jpg', '2024-10-20 04:59:23'),
(7, 'Ube', 'Filipino Flavor, Exquisite ube goodness', 'product5.jpg', '2024-10-20 04:59:23'),
(8, 'Cake', 'Masarap na cake', 'product1.jpg', '2024-11-25 07:26:07');
...
INSERT INTO `registration` (`registration_id`, `name`, `address`, `phone_number`, `created_at`) VALUES
(1, 'tony', 'pol', '1234', '2024-11-18 07:37:22'),
(16, 'ana jaine olayta', 'polangui ', '09766321123', '2024-11-25 07:23:37');
